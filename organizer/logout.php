...
$sql = "update weborg_user set login_status=0 where user_id=".$g_user["user_id"];
$db->query($sql);
$g_user = 0;
session_destroy();
?>
  ...
  <tr>
    ...
    <td>
      ...
      <table width="300" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td width="16"></td>
          <td width="56"><img src="../images/ico_information.gif" width="25" height="25"></td>
          <td width="228">ได้ออกจากระบบเรียบร้อยแล้ว</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
